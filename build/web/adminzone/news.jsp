    ...
    <div class="container-fluid ">
        <div class="row page-name">
            <div class="col-sm-12" style="display: flex; align-items: center; justify-content: center;">
                <h1 style="font-weight: bold;">NEWS & EVENTS</h1>
            </div>
        </div>
        
        <div class="row changepassword-menubar">
            <div class="col-sm-12 align-items-center pt-2">
                <span style="font-size: 25px; font-weight: 500; text-decoration: none; color: #04014a;" class="goback-btn"><a href="adminhome.jsp" style="text-decoration: none; color: #04014a;">Dashboard</a> >> <a style="color: #04014a;">News & Events</a></span>
            </div>
        </div>
        ...
        <div class="row change-password-page">
          ...
          <div class="col-sm-12">
              <form class="form mt-5" style="width: 70%; margin: 0 auto; justify-centent:center; font-size: 22px;" method="post" id="news" action="admincontroller.jsp">
              <!--<p class="title-name">Change Password</p>-->
              <input type="hidden" name="page" value="news"/>
              
              <textarea name="newstext" class="newstext input" required placeholder="Write News"></textarea>

              
              <button class=" btn-addnews mb-5" type="submit">Add News</button>
          </form>
              
              <table class="table table-bordered mt-5" style="width: 80%; margin: auto; font-size: 20px;">
                        <tr style="background-color: #04014a;">
                            <th style="background-color: #04014a; color: #ffc107;">ID</th>
                            <th style="background-color: #04014a; color: #ffc107;">NEWS TEXT</th>
                            <th style="background-color: #04014a; color: #ffc107;">POSTED DATE</th>
