    ...
    <div class="container-fluid ">
        ...
        <div class="row changepassword-menubar">
            <div class="col-sm-12 align-items-center pt-2">
                <span style="font-size: 25px; font-weight: 500; text-decoration: none; color: #04014a;" class="goback-btn"><a href="studenthome.jsp" style="text-decoration: none; color: #04014a;">Dashboard</a> >> <a style="color: #04014a;">Change Password</a></span>
            </div>
        </div>
...
<div class="col-sm-3"></div>
          ...
          <div class="col-sm-6">
            <form class="form mt-5 ms-5 me-5" method="post" id="frmchangepassword" onsubmit="event.preventDefault(); validate();" action="studentcontroller.jsp">
