    ...
    <div class="container-fluid" style="border: 1px solid; min-height: 805px;">
        ...
        <div class="row dashboard-header">
            ...
            <div class="col-sm-1" style="min-height: 100%; ">
                ...
                <a href="logout.jsp"><i class="fa-solid fa-right-from-bracket me-3 logout-btn"></i></a>
            </div>
        </div>
        ...
        <ul>
          ...
          <li class="mt-4">
              <a href="adminhome.jsp" class="dash-menu">
              <span class="title"><i class="fa-solid fa-house me-3"></i>Home</span>
            </a>
          </li>

          <li class="mt-4">
              <a href="student.jsp" class="dash-menu">
              <span class="title"><i class="fa-solid fa-users me-3"></i>Students</span>
            </a>
          </li>

          <li class="mt-4">
              <a href="enquiry.jsp" class="dash-menu">
              <span class="title"><i class="fa-solid fa-user-gear me-3"></i>Enquiry</span>
            </a>
          </li>
          
          <li class="mt-4">
              <a href="course.jsp" class="dash-menu">
              <span class="title"><i class="fa-solid fa-user-gear me-3"></i>Course</span>
            </a>
          </li>

          <li class="mt-4">
              <a href="qb.jsp" class="dash-menu">
              <span class="title"><i class="fa-solid fa-book me-3"></i>Question Bank</span>
            </a>
          </li>

          <li class="mt-4">
              <a href="news.jsp" class="dash-menu">
              <span class="title"><i class="fa-solid fa-calendar-days me-3"></i>News & Event</span>
            </a>
          </li>

          <li class="mt-4">
              <a href="changepassword.jsp" class="dash-menu">
              <span class="title"><i class="fa-solid fa-lock me-3"></i>Change Password</span>
            </a>
          </li>

          <li class="mt-4">
              <a href="logout.jsp" class="dash-menu">
              <span class="title"><i class="fa-solid fa-right-from-bracket me-3"></i>Log Out</span>
            </a>
          </li>
        </ul>
      </div>
            ...
            <div class="col-sm-10 dashboar-main">
                ...
                <div class="row">
                    ...
                    <div class="header-box">
                        <!-----------------------Card Box--------------------- - -->
                        <div class="cardbox">
                          <div class="col-sm-3 mt-5" style=" width: 100%;">
                            <!-- First card -->
                          <div class="Card">
                            <div>
                              <div class="number counter">358</div>
                              <div class="cardName">New Student Registered</div>
                            </div>
                            <div class="iconBox">
                          ...
                          <div class="Card">
                            <div>
                              <div class="number counter">142</div>
                              <div class="cardName">Question Bank</div>
                            </div>
                            <div class="iconBox">
                          ...
                          <div class="Card">
                            <div>
                              <div class="number counter">815</div>
                              <div class="cardName">Student Test Attended</div>
                            </div>
                            <div class="iconBox">
                          ...
                          <div class="Card">
                            <div>
                              <div class="number counter">18</div>
                              <div class="cardName">New Enquiries</div>
                            </div>
                            <div class="iconBox">
                              <ion-icon name="arrow-redo-outline"></ion-icon>
                            </div>
                    ...
                    <div class="img-row">
                        <div class="col-sm-12">
                            <img src="../Images/about-avtar1.jpeg" style="align-item:center;" height=";" width="100%;"/>
                        </div>
                    </div>
        <!-- dashboard main section closed -->
        </div>
